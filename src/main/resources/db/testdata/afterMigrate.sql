...
insert into restaurante (nome, taxa_frete, cozinha_id, data_atualizacao, data_cadastro, ativo) values ('Du Chefe', 17, 2, utc_timestamp, utc_timestamp, 1);
insert into restaurante (nome, taxa_frete, cozinha_id, data_atualizacao, data_cadastro, ativo) values ('Gula', 17, 3, utc_timestamp, utc_timestamp, 1);
